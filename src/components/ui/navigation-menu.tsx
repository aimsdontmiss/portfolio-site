...
// const navigationMenuTriggerStyle = cva(
//     "group/navigation-menu-trigger inline-flex h-9 w-max items-center justify-center rounded-none bg-transparent px-3 py-2 text-xs font-medium tracking-wide text-[#d6d3b1]/80 transition-all outline-none hover:bg-white/5 hover:text-[#d6d3b1] focus:bg-white/5 focus:text-[#d6d3b1] focus-visible:ring-1 focus-visible:ring-white/10 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 data-popup-open:bg-white/5 data-popup-open:text-[#d6d3b1] data-open:bg-white/5 data-open:text-[#d6d3b1]"
// )

const navigationMenuTriggerStyle = cva(
    "group/navigation-menu-trigger inline-flex h-9 w-max items-center justify-center rounded-none bg-transparent px-3 py-2 text-[11px] uppercase tracking-[0.12em] font-medium text-[#d6d3b1]/80 transition-all outline-none hover:bg-white/5 hover:text-[#d6d3b1] focus:bg-white/5 focus:text-[#d6d3b1] focus-visible:ring-1 focus-visible:ring-white/10 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 data-popup-open:bg-white/5 data-popup-open:text-[#d6d3b1] data-open:bg-white/5 data-open:text-[#d6d3b1]"
)
...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      ...
      <CaretDownIcon
          className="relative top-px ml-1 size-3 text-[#d6d3b1]/70 transition duration-300 group-data-popup-open/navigation-menu-trigger:rotate-180 group-data-open/navigation-menu-trigger:rotate-180"
          aria-hidden="true"
      />
    </NavigationMenuPrimitive.Trigger>
  )
